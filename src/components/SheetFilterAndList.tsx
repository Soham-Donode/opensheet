      ...
      <div className="mb-6 px-1">
        ...
        {questions.length > 0 && (
          <div className="flex items-center gap-4">
            ...
            <div className="text-sm font-semibold whitespace-nowrap text-neutral-600 dark:text-neutral-300">
              <span className="text-[#88AB8E]">
                {totalSolved}
              </span>
              <span className="mx-1 text-neutral-400">/</span>
              <span>{questions.length}</span>
              <span className="ml-1 text-neutral-400 font-normal">solved</span>
            </div>
          </div>
        )}
      </div>
